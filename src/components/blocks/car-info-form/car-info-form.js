			...
			<div className="block-wrapper__body">
				<div className="car-info-form__justify-position">
					<ul className="car-info-form__list">
						...
						<li className="car-info-form__item">Направление: Санкт-Петербург (аэропорт Пулково) — Москва (отель Radisson Royal)</li>
					</ul>	
			    	<ul className="car-info-form__list">
			...
			<div className="block-wrapper__body car-info-form--color"> 
				...
				<div className="car-info-form__justify-position">
					<ul className="car-info-form__list">
						...
						<li className="car-info-form__item">С момента бронирования — нет штрафа После 20 сентября, 12:00 — 20 460 ₽</li>
					</ul>	
			    	<ul className="car-info-form__list">	
